...
var BasicGenerator = /** @class */ (function () {
    function BasicGenerator(meta) {
        ...
        this.renderTemplate = function () {
            var render = function (files, metalsmith, done) { return __awaiter(_this, void 0, void 0, function () {
                var fileList, metalsmithMetadata, ignores;
                var _this = this;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, Promise.all(fileList.map(function (fileName) {
    ...
    BasicGenerator.prototype.updateTemplate = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var templatePath, hasTemplate, git, spinner, e_1;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        spinner = ora_1.default(helper_1.info(hasTemplate ? 'updating template...' : 'downloading template...'));
                        _b.label = 1;
                    case 1:
                        _b.trys.push([1, 8, , 9]);
                        spinner.start();
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        hasChildren = fs_1.readdirSync(destination).length;
